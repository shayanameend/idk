...
<footer
  class="mt-8 lg:pt-16 px-8 lg:px-16 border-t border-zinc-300 grid grid-cols-4"
>
  <h2
    class="col-span-2 self-end mb-4 hidden lg:block font-bold text-sm text-[#fe4164]"
  >
    Explore projects
  </h2>
  <h2
    class="col-span-2 lg:col-span-1 self-end mb-4 hidden lg:block font-bold text-sm text-[#fe4164]"
  >
    More about zed
  </h2>
  <h2
  ...
  <div
    class="col-span-4 lg:mt-16 py-4 lg:py-8 lg:border-t border-zinc-300 flex justify-between items-center"
  >
